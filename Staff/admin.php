...
<html lang='fr'>
    ...
    <body>
        ...
        if (isset($_POST['submit'])) {
            ...
            $query = "INSERT INTO personnel (IdService, NomPersonnel, PrenomPersonnel, roles) VALUES ('2', '$nom', '$prenom', '2')";
            $conn->exec($query);
            ...
            $query = "INSERT INTO `user`( `Login`, `MDP`, `IdPersonnel`, `IdRole`) VALUES ('$login','$pass','$id_personnel','2')";
            $conn->exec($query);
            ...
            exit();
                ...
                // Supprimer les entrées de logs correspondant à l'utilisateur
                $query = "DELETE FROM logs WHERE IdUser IN (SELECT IdUser FROM user WHERE IdPersonnel='$medecin')";
                $conn->exec($query);

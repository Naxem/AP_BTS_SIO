            ...
            <div class="globale">
                <form action="requete.php" method="POST">
                    <div class="patient">
                        ...
                        <p>Adresse*<br><input name="adresse" rows="1" cols="50" require></textarea></p>
                        ...
                        <input type="submit" name="infoP" value="Envoyer" class="bouton"/>
                    </div>
                </form>
            </div>
        </section>
        ...
        <section class="page4">
            <div class="globale">
                <form action="requete.php" method="POST">
                    ...
                    <p>Adresse<br><input type="text"name="adresseppre"/></p>
                    </div>
        ...
        <section class="page5">
            ...
            <form action="requete.php" method="POST" enctype="multipart/form-data">
                <div class="pieceJoint">
                    ...
                    <p>Carte d'indentite (reto/verso) :*<br><input type="file" value="Choisir un fichier" name="CarteId" require></p>
